                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="block w-full px-3 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm bg-gray-50 hover:bg-white transition-colors font-mono"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="ECS Engineering">ECS Engineering</option>
