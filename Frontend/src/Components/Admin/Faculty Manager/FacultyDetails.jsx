        ...
        <div className="flex-1 overflow-auto">
          {loading ? (
            ...
            <div className="px-4 sm:px-6 lg:px-8 py-8 space-y-6">
              ...
              {/* Copy all the remaining sections from your original code */}
              ...
              <div className="bg-white/80 backdrop-blur border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 border border-blue-300 rounded-xl text-sm font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 transition-all"
                  >
                    Update Assignments
                  </button>
                </div>
                                    ...
                                    <tr className="bg-emerald-50">
                                      ...
                                      >
                                        <button
                                          ...
                                          className="flex items-center gap-2 px-4 py-2 border border-emerald-300 rounded-xl text-sm font-medium text-emerald-700 bg-white hover:bg-emerald-50 transition-all"
                                        >
